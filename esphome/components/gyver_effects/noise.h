...
/// @param time the time position for the noise field
void fill_raw_2dnoise8(uint8_t *pData, int width, int height, uint8_t octaves, uint16_t x, int16_t scalex, uint16_t y,
                       int16_t scaley, uint16_t time);
...
void fill_raw_2dnoise16into8(uint8_t *pData, int width, int height, uint8_t octaves, uint32_t x, int32_t scalex,
                             uint32_t y, int32_t scaley, uint32_t time);
...
void fill_2dnoise16(GRGB *leds, int width, int height, bool serpentine, uint8_t octaves, uint32_t x, int xscale,
                    ...
                    uint16_t hue_y, uint16_t hue_yscale, uint16_t hue_time, bool blend, uint16_t hue_shift = 0);
